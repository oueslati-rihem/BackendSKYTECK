  ...
  private UserDetailsService jwtService;
     ...
     public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
         return http.csrf().disable()
                 ...
                 .requestMatchers("/**","/authenticate", "/registerNewUser","/updateStudents","/forgotPassword","/upload","/image","/updatePassword","/activate/**","/unban/**" , "/activate-account","/userRoleStatistics" ,"/bannedUserStatistics" ).permitAll()
                 .and()
